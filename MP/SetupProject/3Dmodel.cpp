...
ThreeDimensionalModel::ThreeDimensionalModel(std::string meshPath)
{
    InitializeModel(meshPath);
...
void ThreeDimensionalModel::InitializeModel(std::string meshPath)
{
...
GLuint ThreeDimensionalModel::VAOReference()
{
    return this->VAO;
}

GLuint ThreeDimensionalModel::VBOReference()
{
    return this->VBO;
}

std::vector<GLfloat> ThreeDimensionalModel::VertexData()
{
